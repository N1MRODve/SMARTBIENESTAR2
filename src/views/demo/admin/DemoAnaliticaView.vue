      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            <button 
              @click="verDetallesPrediccion(prediccion)"
...
const revisarAlerta = (alerta) => {
  toast.add({
    severity: 'info',
    summary: 'Revisando alerta',
    detail: `Analizando: ${alerta.titulo}`,
    life: 3000
  })
}

const verDetallesPrediccion = (prediccion) => {
  toast.add({
    severity: 'info',
    summary: 'Detalles de predicción',
    detail: `Mostrando análisis detallado de: ${prediccion.titulo}`,
    life: 3000
  })
}
</script>